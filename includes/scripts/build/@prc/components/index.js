...
`,Of=Ze.div`
	...
	text-transform: uppercase;
	letter-spacing: 0.5px;
`;function Bf({title:e,description:t,url:n,image:r,children:i}){const o=g.useMemo(()=>{try{return new URL(n).hostname.replace("www.","")}catch{return n}},[n]),s=e.length>60?`${e.slice(0,57)}...`:e,a=t.length>100?`${t.slice(0,97)}...`:t;return(0,u.jsxs)(Pf,{children:[(0,u.jsx)(_f,{children:"Threads"}),(0,u.jsxs)(Ef,{children:[(r||i)&&(0,u.jsx)(Mf,{children:i||(0,u.jsx)(Rf,{src:r,alt:""})}),(0,u.jsxs)(If,{children:[(0,u.jsx)(zf,{children:s}),(0,u.jsx)(Lf,{children:a}),(0,u.jsx)(Of,{children:o})]})]})]})}const Vf=Ze.div`
	font-family:
		-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial,
		sans-serif;
	margin-bottom: 1rem;
