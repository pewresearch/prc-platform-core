...
class Pagination {
	...
	/**
	 * This function will return the item from the $items array by pagenum.
	 *
	 * @param int $pagenum
	 * @return array
	 */
	...
	/**
	 * This function will return the markup for the item.
	 *
	 * @param int    $pagenum
	...
	/**
	 * This function will return the markup for the range of links.
	 *
	 * @param string $item_classnames
	 * @return string
	 */
