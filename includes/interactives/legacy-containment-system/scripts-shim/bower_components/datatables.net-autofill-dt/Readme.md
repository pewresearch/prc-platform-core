...
This package contains distribution files required to style [AutoFill extension](https://datatables.net/extensions/autofill) for [DataTables](https://datatables.net/) .
...
```
var $ = require( 'jquery' );
require( 'datatables.net-autofill-dt' )( window, $ );
```
