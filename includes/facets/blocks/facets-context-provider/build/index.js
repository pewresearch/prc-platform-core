...
/* harmony import */ var _use_facetwp_settings__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./use-facetwp-settings */ "./src/use-facetwp-settings.js");
...
function Edit({
  ...
  const {
    settings,
    isLoading
  } = (0,_use_facetwp_settings__WEBPACK_IMPORTED_MODULE_4__["default"])();
  const newContext = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => {
    return {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.BlockContextProvider, {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ useFacetWPSettings)
/* harmony export */ });
...
function useFacetWPSettings() {
  ...
  const reduceSettings = newSettings => {
    ...
    Object.keys(facets).forEach(facetKey => {
      ...
      newFacets[name] = {
        ...
        limit: facets[facetKey]?.count,
        // I dont like the "count" property in FacetWP to describe what is meant to be a "hard limit" as opposed to the soft limit, I'll refer to this as just "limit".
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
      path: '/prc-api/v3/facets/get-settings'
    }).then(settings => {
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"prc-platform/facets-context-provider","version":"0.1.0","title":"Facets Context Provider","description":"Handles passing facets context to query blocks and facet ui blocks.","category":"theme","keywords":["facets","query","loop"],"supports":{"anchor":false,"html":false,"reusable":false,"multiple":false,"interactivity":{"clientNavigation":true}},"usesContext":["postType","templateSlug","previewPostType","facetsContextProvider"],"textdomain":"prc-facets-context-provider","editorScript":"file:./index.js","viewScriptModule":"file:./view.js","style":"file:./style-index.css"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunk_pewresearch_prc_platform_facets_context_provider"] = globalThis["webpackChunk_pewresearch_prc_platform_facets_context_provider"] || [];
