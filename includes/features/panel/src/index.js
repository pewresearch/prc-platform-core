...
const PLUGIN_NAME = 'prc-platform-feature-options';

function FeatureOptionsPanel() {
	const { postType, postId, postSlug } = useSelect((select) => {
	...
	return (
		<Fragment>
			...
			<PluginPrePublishPanel>
				<p>Dont forget to double check your feature rewrites...</p>
			</PluginPrePublishPanel>
		</Fragment>
	);
}
